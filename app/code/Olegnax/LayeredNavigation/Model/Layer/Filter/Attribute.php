...
class Attribute extends \Magento\CatalogSearch\Model\Layer\Filter\Attribute
{
    ...
    protected function addState($values)
    {
        ...
        $labels = array_unique(array_merge(...$labels));
     ...
     * @noinspection PhpUnusedParameterInspection
     */
    public function shouldVisible($id)
    {
        return true;
    }
    ...
    protected function _getItemsData()
    {
        ...
        $attribute = $this->getAttributeModel();
        if ($this->hasCurrentValue() && !$this->shouldVisible($attribute->getAttributeId())) {
            return [];
        }
